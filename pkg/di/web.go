...
func InitGinServer(m []gin.HandlerFunc, userHdl *userApi.UserHandler, authHdl *authApi.AuthHandler, treeHdl *treeApi.TreeHandler, k8sHdl *k8sApi.K8sHandler) *gin.Engine {
	server := gin.Default()
	server.Use(m...)
