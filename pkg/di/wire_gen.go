...
func ProvideCmd() *Cmd {
	...
	processService := service4.NewProcessService(processDAO, logger, userDAO)
	...
	statisticsDAO := dao3.NewStatisticsDAO()
	statisticsService := service4.NewStatisticsService(statisticsDAO)
