...
func ProvideCmd() *Cmd {
	...
	deploymentService := service4.NewDeploymentService(clusterDAO, k8sClient, logger)
	...
	nodeService := service4.NewNodeService(clusterDAO, k8sClient, logger)
	k8sNodeHandler := api4.NewK8sNodeHandler(logger, nodeService)
	podService := service4.NewPodService(clusterDAO, k8sClient, logger)
	...
	taintService := service4.NewTaintService(clusterDAO, k8sClient, logger)
	...
	yamlTaskService := service4.NewYamlTaskService(yamlTaskDAO, clusterDAO, yamlTemplateDAO, k8sClient, logger)
	k8sYamlTaskHandler := api4.NewK8sYamlTaskHandler(logger, yamlTaskService)
	yamlTemplateService := service4.NewYamlTemplateService(yamlTemplateDAO, yamlTaskDAO, k8sClient, logger)
	k8sYamlTemplateHandler := api4.NewK8sYamlTemplateHandler(logger, yamlTemplateService)
	configMapService := service4.NewConfigMapService(k8sClient, logger)
	k8sConfigMapHandler := api4.NewK8sConfigMapHandler(logger, configMapService)
	secretService := service4.NewSecretService(k8sClient, logger)
	k8sSecretHandler := api4.NewK8sSecretHandler(logger, secretService)
	daemonSetService := service4.NewDaemonSetService(clusterDAO, k8sClient, logger)
	k8sDaemonSetHandler := api4.NewK8sDaemonSetHandler(logger, daemonSetService)
	eventService := service4.NewEventService(clusterDAO, k8sClient, logger)
	k8sEventHandler := api4.NewK8sEventHandler(logger, eventService)
	pvService := service4.NewPVService(clusterDAO, k8sClient, logger)
	k8sPVHandler := api4.NewK8sPVHandler(logger, pvService)
	pvcService := service4.NewPVCService(clusterDAO, k8sClient, logger)
	k8sPVCHandler := api4.NewK8sPVCHandler(logger, pvcService)
	ingressService := service4.NewIngressService(clusterDAO, k8sClient, logger)
	k8sIngressHandler := api4.NewK8sIngressHandler(logger, ingressService)
	statefulSetService := service4.NewStatefulSetService(k8sClient, logger)
	k8sStatefulSetHandler := api4.NewK8sStatefulSetHandler(logger, statefulSetService)
	serviceAccountService := service4.NewServiceAccountService(clusterDAO, k8sClient, logger)
	k8sServiceAccountHandler := api4.NewK8sServiceAccountHandler(logger, serviceAccountService)
	serviceRoleService := service4.NewRoleService(clusterDAO, k8sClient, logger)
	roleAPI := api4.NewRoleAPI(serviceRoleService, logger)
	clusterRoleService := service4.NewClusterRoleService(clusterDAO, k8sClient, logger)
	clusterRoleAPI := api4.NewClusterRoleAPI(clusterRoleService, logger)
	roleBindingService := service4.NewRoleBindingService(clusterDAO, k8sClient, logger)
	roleBindingAPI := api4.NewRoleBindingAPI(roleBindingService, logger)
	clusterRoleBindingService := service4.NewClusterRoleBindingService(clusterDAO, k8sClient, logger)
	clusterRoleBindingAPI := api4.NewClusterRoleBindingAPI(clusterRoleBindingService, logger)
	rbacService := service4.NewRBACService(k8sClient)
