...
func ProvideCmd() *Cmd {
	...
	treeNodeService := service6.NewTreeNodeService(logger, treeNodeDAO, treeEcsDAO, userDAO)
	treeNodeHandler := api8.NewTreeNodeHandler(treeNodeService)
	treeEcsService := service6.NewTreeEcsService(logger, treeEcsDAO)
