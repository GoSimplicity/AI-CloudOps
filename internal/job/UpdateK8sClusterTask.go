...
func (k *UpdateK8sClusterTask) processClusterConfig(ctx context.Context, cluster *model.K8sCluster, retryCount int, initTimeout time.Duration, maxConcurrent int) error {
