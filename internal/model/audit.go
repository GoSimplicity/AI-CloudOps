...
type AuditLog struct {
	...
	UpdatedAt     time.Time      `json:"-" gorm:"comment:更新时间"`
...
type AuditLogDetail struct {
	...
	Username      string    `json:"username" gorm:"comment:操作用户名"`
...
type ListAuditLogsRequest struct {
	...
	StartTime     time.Time `json:"start_time" validate:"required" gorm:"comment:开始时间"`
	EndTime       time.Time `json:"end_time" validate:"required,gtfield=StartTime" gorm:"comment:结束时间"`
}
